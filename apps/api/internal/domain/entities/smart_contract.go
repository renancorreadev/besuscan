...
// DailyDeployment representa deployments diários
type DailyDeployment struct {
	Date  string `json:"date"`
	Count int64  `json:"count"`
}

// ContractType representa tipos de contratos e suas estatísticas
...
// SmartContractStats representa estatísticas agregadas de smart contracts
type SmartContractStats struct {
	TotalContracts        int64             `json:"total_contracts"`
	VerifiedContracts     int64             `json:"verified_contracts"`
	ActiveContracts       int64             `json:"active_contracts"`
	TokenContracts        int64             `json:"token_contracts"`
	TotalTransactions     int64             `json:"total_transactions"`
	TotalGasUsed          string            `json:"total_gas_used"`
	TotalValueTransferred string            `json:"total_value_transferred"`
	DailyDeployments      []DailyDeployment `json:"daily_deployments"`
	ContractTypes         []ContractType    `json:"contract_types"`
}
