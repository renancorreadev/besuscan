...
pragma solidity >=0.4.16 >=0.5.0 >=0.6.2 >=0.8.4 ^0.8.20 ^0.8.27;
...
// solc --bin --abi --evm-version london src/Drex.sol -o abis/ --overwrite

contract DREX is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC1363, ERC20Permit {
    constructor(address initialOwner)
        ERC20("DREX", "MTK")
